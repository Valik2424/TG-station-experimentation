...
/datum/plant_gene/trait/custom_stat
	name = "Custom Stat"
	icon = "question-circle" 
	description = "A custom plant characteristic."
	var/stat_name
	var/stat_value

/datum/plant_gene/trait/custom_stat/New(new_stat_name, new_stat_value)
	. = ..()
	stat_name = new_stat_name
	stat_value = new_stat_value

/datum/plant_gene/trait/custom_stat/get_name()
